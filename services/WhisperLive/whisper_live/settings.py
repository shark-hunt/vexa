...
MAX_BUFFER_S = int(os.getenv("MAX_BUFFER_S", "120"))
...
DISCARD_BUFFER_S = int(os.getenv("DISCARD_BUFFER_S", "30"))
...
CLIP_IF_NO_SEGMENT_S = int(os.getenv("CLIP_IF_NO_SEGMENT_S", "25"))
...
CLIP_RETAIN_S = int(os.getenv("CLIP_RETAIN_S", "5"))
...
MIN_AUDIO_S = float(os.getenv("MIN_AUDIO_S", "1"))
# Tier2 (deferred) defaults: larger windows for lower service pressure.
MIN_AUDIO_S_TIER2 = float(os.getenv("MIN_AUDIO_S_TIER2", "20"))
...
MIN_TIME_BETWEEN_REQUESTS_S = float(os.getenv("MIN_TIME_BETWEEN_REQUESTS_S", "0.5"))
# Tier2 (deferred) pacing default.
MIN_TIME_BETWEEN_REQUESTS_S_TIER2 = float(os.getenv("MIN_TIME_BETWEEN_REQUESTS_S_TIER2", "20.0"))
...
SAME_OUTPUT_THRESHOLD = int(os.getenv("SAME_OUTPUT_THRESHOLD", "3"))
# Tier2 (deferred) requires fewer reconfirmations before cursor advance.
SAME_OUTPUT_THRESHOLD_TIER2 = int(os.getenv("SAME_OUTPUT_THRESHOLD_TIER2", "2"))
...
SHOW_PREV_OUT_THRESH_S = float(os.getenv("SHOW_PREV_OUT_THRESH_S", "5"))
...
# conversation.
ADD_PAUSE_THRESH_S = float(os.getenv("ADD_PAUSE_THRESH_S", "3"))
